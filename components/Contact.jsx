...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://endpoints.abhi-swami.in/api/contact",
        {
          method: "POST",
          headers: {
  ...
  return (
    <section
      id="contact"
      className={`relative py-16 md:py-20 w-full overflow-hidden transition-opacity duration-1000 ease-out ${
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          className={`relative w-full border-2 border-[rgba(var(--color-background-primary-dark),0.3)] backdrop-blur-sm bg-[rgba(var(--color-background-primary-dark),0.8)] mx-auto rounded-2xl overflow-hidden shadow-[0_0_25px_rgba(var(--color-background-primary-dark),0.2)] transition-all duration-700 ${
        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row w-full px-3 xs:px-4 sm:px-6 md:px-8 lg:px-12 py-4 xs:py-6 md:py-8 gap-6 xs:gap-8 md:gap-12 lg:gap-16">
            {/* Get in Touch Section */}
            <div
              className={`w-full md:w-2/5 transition-all duration-700 delay-300 ${
                isVisible
                  ? "transform-none opacity-100"
                  : "transform -translate-x-10 opacity-0"
              }`}
            >
              <h3 className="text-lg xs:text-xl md:text-2xl text-[rgb(var(--color-text-primary-light))] mb-4 xs:mb-6 md:mb-8 font-medium relative">
                Get in Touch
              </h3>

              <div className="space-y-3 xs:space-y-4 md:space-y-6">
                {/* Email */}
                <div className="group flex items-center p-2 xs:p-3 sm:p-4 rounded-xl transition-all duration-300 hover:bg-[rgba(var(--color-background-primary-light),0.3)] lg:hover:bg-[rgba(var(--color-background-primary-light),0.6)]">
                  <div className="relative">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="relative inline-flex items-center justify-center w-10 h-10 xs:w-12 xs:h-12 rounded-full bg-gradient-to-br from-[rgb(var(--color-background-secondary-dark))] to-[rgb(var(--color-background-secondary-light))] text-[rgb(var(--color-text-secondary-light))] transition-all duration-300 group-hover:shadow-lg group-hover:shadow-[rgba(var(--color-background-secondary-dark),0.4)]"
                    >
                      <svg
                  ...
                  <div className="ml-2 xs:ml-4 flex-1 transition-all duration-300 hover:translate-x-1 lg:group-hover:translate-x-2">
                    <span className="block text-xs uppercase tracking-wider text-[rgba(var(--color-text-primary-light),0.6)] mb-1">
                      Email
                    </span>
                    <div className="flex items-center gap-1 xs:gap-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="text-xs xs:text-sm md:text-base text-[rgb(var(--color-text-primary-light))] hover:text-[rgb(var(--color-text-primary-dark))] lg:hover:text-[rgb(var(--color-text-primary-dark))] transition-colors duration-300"
                        id="contact-email"
                      >
                      ...
                      <button
                        onClick={() =>
                          handleCopy("abhi.swame@gmail.com", "email")
                        }
                        className="p-1 rounded-md hover:bg-[rgba(var(--color-background-primary-light),0.2)] lg:hover:bg-[rgba(var(--color-background-primary-light),0.3)] transition-colors duration-200"
                        title="Copy email"
                      >
                        {copiedField === "email" ? (
                          <svg
                          ...
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="w-4 h-4 text-[rgb(var(--color-text-primary-light))]"
                            viewBox="0 0 24 24"
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="2"
                ...
                <div className="group flex items-center p-2 xs:p-3 sm:p-4 rounded-xl transition-all duration-300 hover:bg-[rgba(var(--color-background-primary-light),0.3)] lg:hover:bg-[rgba(var(--color-background-primary-light),0.6)]">
                  ...
                  <div className="ml-2 xs:ml-4 transition-all duration-300 hover:translate-x-1 lg:group-hover:translate-x-2">
                    <span className="block text-xs uppercase tracking-wider text-[rgba(var(--color-text-primary-light),0.6)] mb-1">
                      GitHub
                    </span>
                    <a
            ...
            <div
              className={`relative w-full md:w-3/5 transition-all duration-700 delay-500 ${
                isVisible
                  ? "transform-none opacity-100"
              ...
              >
                ...
                <div className="flex justify-center pt-2 xs:pt-4">
                  <button
                    type="submit"
                    disabled={submitting}
                    className={`group relative overflow-hidden px-4 py-2 xs:px-6 xs:py-2.5 sm:px-8 sm:py-3 text-sm xs:text-base rounded-full bg-gradient-to-r from-[rgb(var(--color-background-secondary-dark))] to-[rgb(var(--color-background-secondary-light))] text-[rgb(var(--color-text-secondary-dark))] font-medium shadow-md hover:shadow-lg hover:shadow-[rgba(var(--color-background-secondary-dark),0.4)] focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-background-secondary-light))] focus:ring-offset-2 focus:ring-offset-[rgb(var(--color-background-primary-dark))] transition-all duration-300 ${
                  ...
                  >
                    <span className="relative z-10 flex items-center">
                      {submitting ? (
                        <>
                          <svg
                            className="animate-spin -ml-1 mr-2 h-4 w-4 text-[rgb(var(--color-text-secondary-dark))]"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                          >
                ...
                {submitSuccess && (
                  <div className="relative overflow-hidden px-4 py-3 rounded-lg bg-[rgba(var(--color-background-secondary-light),0.1)] border border-[rgba(var(--color-background-secondary-dark),0.3)] text-center animate-in fade-in slide-in-from-bottom duration-500">
                    <div className="flex items-center justify-center">
                      <svg
                        className="w-5 h-5 mr-2 text-[rgb(var(--color-background-secondary-dark))]"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                      ...
                      <span className="text-[rgb(var(--color-text-primary-dark))] max-md:text-sm md:font-medium">
                        Message sent successfully!
                      </span>
                    </div>
                    <span className="block text-xs mt-1 text-[rgba(var(--color-text-primary-light),0.8)]">
                ...
                {submitError && (
                  <div className="relative p-2 overflow-hidden rounded-lg bg-[rgba(var(--color-background-secondary-light),0.1)] text-center animate-in fade-in slide-in-from-bottom duration-500">
                    <div className="p-1 max-md:text-sm md:px-4 md:py-3 rounded-lg bg-red-50 border border-red-200 text-red-500 text-center animate-in fade-in slide-in-from-bottom duration-500">
                      <div className="flex items-center justify-center">
                        <svg
