  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 xs:px-2 sm:px-4 lg:px-6">
        ...
        {/* Slider */}
        <div className="relative mx-auto my-0 sm:my-2 md:my-4 max-w-6xl overflow-hidden">
          <div
            className="relative w-full h-[200px] xs:h-[180px] sm:h-[230px] md:h-[260px] lg:h-[290px] flex justify-center items-center"
            role="region"
          ...
          {/* Indicators */}
          <div
            className="flex justify-center gap-1 xs:gap-1.5 sm:gap-2 my-2"
            role="tablist"
            aria-label="Skill slide selection"
          >
            {skills.map((skill, index) => (
              <button
                key={index}
